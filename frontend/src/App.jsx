...
// =============================================================================
// 1. ASSET MAPPING & IMPORT INSTRUCTIONS (Strict adherence to prompt specifications)
// =============================================================================
...
import cloudsImg from './assets/Home/clouds.png'
...
// Clean individual cloud sprites (Both Mockup Cyan & Original Gold available)
...
import goldCloud1 from './assets/Home/gold_cloud_1.png'
import goldCloud2 from './assets/Home/gold_cloud_2.png'
import goldCloud3 from './assets/Home/gold_cloud_3.png'
import goldCloud4 from './assets/Home/gold_cloud_4.png'
import goldCloud5 from './assets/Home/gold_cloud_5.png'

export default function App() {
  const [activeModal, setActiveModal] = useState(null)
  const [lanternIgnited, setLanternIgnited] = useState(false)
  const [cloudStyle, setCloudStyle] = useState('cyan') // 'cyan' (exact Web 1920 mockup) or 'gold' (clouds.png original)

  // Choose the cloud sprite set according to active theme
  const clouds = cloudStyle === 'cyan'
    ? { c1: cyanCloud1, c2: cyanCloud2, c3: cyanCloud3, c4: cyanCloud4, c5: cyanCloud5 }
    : { c1: goldCloud1, c2: goldCloud2, c3: goldCloud3, c4: goldCloud4, c5: goldCloud5 }
  ...
  return (
    ...
    >
      ...
      <header className="relative w-full pt-3 sm:pt-5 md:pt-7 px-4 z-20 flex flex-col items-center">
        ...
        >
          <img
            ...
            className={`w-11 sm:w-15 md:w-19 lg:w-22 h-auto object-contain transition-all duration-300 ${
              lanternIgnited
        ...
        >
          <img
            ...
            className={`w-16 sm:w-22 md:w-28 lg:w-34 h-auto object-contain transition-all duration-300 ${
              lanternIgnited
                ? 'filter drop-shadow-[0_0_40px_rgba(255,230,80,1)] brightness-125'
        ...
        <div className="relative w-full max-w-[880px] lg:max-w-[980px] flex flex-col items-center justify-center mx-auto">
          ...
          >
            <img
              ...
              className={`w-24 sm:w-32 md:w-42 lg:w-48 h-auto object-contain -rotate-[14deg] transition-all duration-300 ${
                lanternIgnited
      ...
      {/* Theme Pill (Toggle between Cyan Mockup & Gold Cloud Palettes) */}
      <div className="absolute top-3 right-3 z-40 hidden sm:flex items-center gap-1.5 bg-black/40 backdrop-blur-md px-2.5 py-1 rounded-full border border-yellow-400/30 text-xs text-yellow-300 font-medium shadow-lg">
        <span className="opacity-75 text-[11px]">Clouds:</span>
        <button
          onClick={() => setCloudStyle('cyan')}
